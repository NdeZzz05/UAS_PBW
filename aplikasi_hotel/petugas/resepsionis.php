...
<head>
  ...
  <title>Resepsionis Hotel Harrington</title>
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="#" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Hotel Harrington</span>
      </a>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>RESEPSIONIS Hotel Harrington</h1>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      </section>
        ...
        if (!empty(@$_GET['page'])) {
          switch (@$_GET['page']) {
            case 'reservasi':
              ...
              break;
            default:
              echo "SELAMAT DATANG RESEPSIONIS Hotel Harrington";
              break;
          }
        }
