...
<head>
    ...
    <title>Hotel Harrington</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <!-- <link rel="manifest" href="site.webmanifest"> -->
    <link rel="shortcut icon" type="image/x-icon" href="img/harrington4.png">
                ...
                <div class="container-fluid p-0">
                    <div class="row align-items-center no-gutters">
                        ...
                        <div class="col-xl-2 col-lg-2">
                            <div class="logo-img">
                                <a href="index.html">
                                    <img src="img/harrington4.png" alt="">
                                </a>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-8 col-md-7 col-lg-9">
                        <p class="copy_right">
                            ...
                            </script> Unsika|Pemrograman Berbasis Web <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Tim Hotel</a>
                            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
